...
class Household(abce.Agent, abce.Household):
    def init(self, num_firms):
        ...
        self.consume_everything = list(cd.keys())
        self.utility_function = self.create_cobb_douglas_utility_function(cd)
    ...
    def consumption(self):
        ...
        self.current_utiliy = self.consume(self.utility_function,self.consume_everything)
